...
namespace MUNityCore.Migrations
{
    ...
    [Migration("20210513092641_Added Columns ListOfSpeakersLog")]
    partial class AddedColumnsListOfSpeakersLog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MUNityCore.Models.Speakerlists.ListOfSpeakersLog", b =>
                {
                    b.Property<long>("ListOfSpeakersLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    b.Property<long>("PermitedQuestionsSeconds")
                        .HasColumnType("bigint");

                    b.Property<long>("PermitedSpeakingSeconds")
                        .HasColumnType("bigint");

                    b.Property<string>("SpeakerIso")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<string>("SpeakerName")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<string>("SpeakerlistListOfSpeakersId")
                        .HasColumnType("varchar(95) CHARACTER SET utf8mb4");

                    b.Property<int>("TimesOnQuestions")
                        .HasColumnType("int");

                    b.Property<int>("TimesOnSpeakerlist")
                        .HasColumnType("int");

                    b.Property<int>("TimesQuestioning")
                        .HasColumnType("int");

                    b.Property<int>("TimesSpeaking")
                        .HasColumnType("int");

                    b.Property<long>("UsedQuestionSeconds")
                        .HasColumnType("bigint");

                    b.Property<long>("UsedSpeakerSeconds")
                        .HasColumnType("bigint");

                    b.HasKey("ListOfSpeakersLogId");

                    b.HasIndex("SpeakerlistListOfSpeakersId");

                    b.ToTable("ListOfSpeakersLog");
                });
            ...
            modelBuilder.Entity("MUNityCore.Models.Speakerlists.ListOfSpeakersLog", b =>
                {
                    b.HasOne("MUNity.Models.ListOfSpeakers.ListOfSpeakers", "Speakerlist")
                        .WithMany()
                        .HasForeignKey("SpeakerlistListOfSpeakersId");

                    b.Navigation("Speakerlist");
                });
