...
{
    public partial class AddedSimulationLogandInvites : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SimulationInvites",
                columns: table => new
                {
                    SimulationInviteId = table.Column<string>(type: "varchar(95) CHARACTER SET utf8mb4", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimulationInvites", x => x.SimulationInviteId);
                    table.ForeignKey(
                        name: "FK_SimulationInvites_SimulationUser_UserSimulationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimulationLog", x => x.SimulationLogId);
                    table.ForeignKey(
                        name: "FK_SimulationLog_Simulations_SimulationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SimulationInvites_UserSimulationUserId",
                table: "SimulationInvites",
