...
namespace MUNity.Database.Models.LoS
{
    ...
    /// You can give any time of name, so you could set it to a person a Country or DelegationWishes.
    /// </summary>
    public class Speaker : ISpeaker
    {
        ...
        /// The Id has nothing to do with the Paricipant, DelegationWishes, Country etc.
        /// </summary>
